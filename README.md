...
Ghost Mail is a free and open-source <a href=https://apps.apple.com/ca/app/ghost-mail/id6741405019>iPhone app</a> to manage email alias' for Cloudflare hosted domains. It lets you quickly create disposable email addresses on the fly, shielding your main email from unwanted messages, data breaches, tracking and targeted ads. With full open-source transparency enjoy peace of mind knowing that your primary email address is being kept private!
